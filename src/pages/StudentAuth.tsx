  ...
  return (
    <div style={{
      ...
      <div style={{ textAlign: 'center', marginBottom: '1rem', color: 'white' }}>
        <h1 style={{ fontSize: '2rem', fontWeight: 700, margin: 0 }}>Student {isSignup ? 'Registration' : 'Login'}</h1>
        <p style={{ color: 'rgba(255,255,255,0.9)', marginTop: 8 }}>{isSignup ? 'Create your student account' : 'Welcome back! Please login'}</p>
      </div>
